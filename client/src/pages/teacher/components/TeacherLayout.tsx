...
export default function TeacherLayout({ children, title }: TeacherLayoutProps) {
  ...
  const menuItems = [
    { path: '/teacher/dashboard', label: '班级分析', icon: <LayoutDashboardIcon /> },
    { path: '/teacher/students', label: '学生管理', icon: <UsersIcon /> },
    { path: '/teacher/progress', label: '进退步分析', icon: <TrendingUpIcon /> },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-full bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center text-white font-medium">
                  {user?.name?.[0] || '教'}
                </div>
